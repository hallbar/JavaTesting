...
public class CardTest {
	...
	public void testEquals() {
		Card card1 = new Card(Card.Face.THREE, Card.Suit.CLUB); 
		Card card2 = new Card(Card.Face.THREE, Card.Suit.CLUB);
		Card card3 = new Card(Card.Face.FOUR, Card.Suit.CLUB);
		Card card4 = new Card(Card.Face.THREE, Card.Suit.HEART);

		boolean oneEqualsTwo = card1.equals(card2);
		assertEquals(true, oneEqualsTwo);

		boolean twoEqualsOne = card2.equals(card1);
		assertEquals(true, twoEqualsOne);

		boolean oneEqualsThree = card1.equals(card3);
		assertEquals(false, oneEqualsThree);

		boolean oneEqualsFour = card1.equals(card4);
		assertEquals(false, oneEqualsFour);
	}
